...
function App() {
    return (
        <div className="flex w-full h-full flex-col">
            <div className="flex w-full h-full bg-stone-200 px-4 py-2 border-b border-gray-400 cursor-pointer items-center">
                ...
                <div className="ml-6 flex items-center justify-between w-full -md:hidden">
                    <h2 className="text-xs flex pointer-cursor hover:bg-slate-300 p-3 rounded-md font-semibold">
                        All tasks{' '}
                        <svg
                            className="w-4 h-4"
                            aria-hidden="true"
